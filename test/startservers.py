...
def start(race_detection, fakeclock=None, account_uri=None):
    ...
    progs.extend([
        ...
        [8103, 'boulder-sa --config %s --addr sa2.boulder:9005 --debug-addr :8103' % os.path.join(default_config_dir, "sa.json")],
        ...
        [8109, 'boulder-publisher --config %s --addr publisher2.boulder:9001 --debug-addr :8109' % os.path.join(default_config_dir, "publisher.json")],
        ...
        [8104, 'boulder-va --config %s --addr va2.boulder:9002 --debug-addr :8104' % os.path.join(default_config_dir, "va.json")],
        ...
        [8101, 'boulder-ca --config %s --ca-addr ca2.boulder:9003 --ocsp-addr ca2.boulder:9006 --debug-addr :8101' % os.path.join(default_config_dir, "ca.json")],
        ...
        [8102, 'boulder-ra --config %s --addr ra2.boulder:9004 --debug-addr :8102' % os.path.join(default_config_dir, "ra.json")],
